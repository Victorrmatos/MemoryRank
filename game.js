...
var ask = "Unknown Player" 
 ...
 var rankPlH = ["e","m","o","r","y"]; 
  ...
  const firebaseConfig = {
    ...
    databaseURL: "https://memoryrank-default-rtdb.europe-west1.firebasedatabase.app",
...
firebase.database().ref('https://memoryrank-default-rtdb.europe-west1.firebasedatabase.app/memoryrank').once('value').then((snapshot) => {
